...
\draw [fill = orange] (9, 0) rectangle (9.5, 1) node[midway] {\Lightning}; 
\draw [fill = yellow] (9, 1) rectangle (9.5, 2) node[midway] {\Lightning}; 
...
\draw [fill = red] (15, 0) rectangle (15.5, 1) node[midway] {\Lightning}; 
\draw [fill = yellow] (15, 1) rectangle (15.5, 2) node[midway] {\Lightning}; 
\draw [fill = yellow] (15.5, 0) rectangle (16, 2);
\draw [fill = red] (16, 0) rectangle (16.5, 1) node[midway] {\Lightning}; 
\draw [fill = orange] (16, 1) rectangle (16.5, 2) node[midway] {\Lightning}; 
